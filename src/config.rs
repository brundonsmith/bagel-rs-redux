...
pub struct Rules {
    ...
    pub lower_camel_case_module_constants: RuleSeverityOrOff,

    /// Require that top-level function names in modules are in lower camel case
    pub lower_camel_case_module_functions: RuleSeverityOrOff,

    /// Require that top-level type names in modules are in upper camel case
    pub upper_camel_case_module_types: RuleSeverityOrOff,

    /// Require that local variables and constants are in lower camel case
    pub lower_camel_case_module_local_variables: RuleSeverityOrOff,
    ...
    pub no_dead_code: NoDeadCodeConfig,
    ...
    /// information)
    pub no_unnecessary_conditional: RuleSeverityOrOff,
    ...
    pub function_syntax: FunctionSyntaxConfig,
}
...
pub struct IndentationConfig {
    pub severity: RuleSeverityOrOff,
    pub spaces: u8,
}
